...
Generated by `python -m eval.report` from 18 files in `eval/results/`. Runs produced at commit `10c722dbe189` (working tree dirty at run time) on 2026-08-01T07:07:13+00:00.
